...
show_experimental_warning() {
    ...
    echo -e "${RED}║${RESET}                                                             ${RED}║${RESET}"
    echo -e "${RED}║${RESET}  Settings migration between desktop environments is         ${RED}║${RESET}"
    echo -e "${RED}║${RESET}  fragile and may not work correctly in all cases.          ${RED}║${RESET}"
    echo -e "${RED}║${RESET}                                                             ${RED}║${RESET}"
...
show_preview() {
    ...
    echo ""
    local display_path="${BACKUP_DIR/#$HOME\//\~}"
    echo -e "${BOLD}Backup Directory:${RESET} $display_path"
    echo ""
